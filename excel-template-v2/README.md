...
| `excel-template.trex` | Tableau manifest (edit before use) |
| `README.md` | This file |

## Quick Start

1. **Edit the .trex manifest** (optional) — the default URL points to
   `https://example.com/excel-template/index.html`. Replace the URL with your own
...
4. **Open the .trex in Tableau** — In Tableau Desktop open a workbook,
   ...
   edited `excel-template.trex` file.
...
For questions or issues visit https://github.com/devizable/devizable.github.io/blob/main/excel-template/README.md
