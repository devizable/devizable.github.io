# Excel Template V2 — Self-Hosted Extension

This package contains everything you need to host the **Excel Template V2** Tableau extension
...
| `excel-template-v2.trex` | Tableau manifest (edit before use) |
| `README.md` | This file |

## Quick Start

1. **Edit the .trex manifest** (optional) — the default URL points to
   `https://example.com/excel-template-v2/index.html`. Replace the URL with your own
   server address where you are hosting these files.
...
4. **Open the .trex in Tableau** — In Tableau Desktop open a workbook,
   ...
   edited `excel-template-v2.trex` file.
...
For questions or issues visit https://github.com/devizable/devizable.github.io/blob/main/excel-template-v2/README.md
