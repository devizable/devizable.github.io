# Self-Service Export — Self-Hosted Extension

This package contains everything you need to host the **Self-Service Export** Tableau extension
...
| `self-service.trex` | Tableau manifest (edit before use) |
| `README.md` | This file |

## Quick Start

1. **Edit the .trex manifest** (optional) — the default URL points to
   `https://devizable.github.io/self-service/index.html`. If you are hosting
