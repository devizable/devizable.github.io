# Crosstab Export — Self-Hosted Extension

This package contains everything you need to host the **Crosstab Export** Tableau extension
...
| `crosstab-export.trex` | Tableau manifest (edit before use) |
| `README.md` | This file |

## Quick Start

1. **Edit the .trex manifest** (optional) — the default URL points to
   `https://example.com/crosstab-export/index.html`. Replace the URL with your own
...
4. **Open the .trex in Tableau** — In Tableau Desktop open a workbook,
   ...
   edited `crosstab-export.trex` file.
