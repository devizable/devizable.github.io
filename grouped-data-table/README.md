# Grouped Data Table — Self-Hosted Extension

This package contains everything you need to host the **Grouped Data Table** Tableau extension
...
| `grouped-data-table.trex` | Tableau manifest (edit before use) |
| `README.md` | This file |

## Quick Start

1. **Edit the .trex manifest** (optional) — the default URL points to
   `https://example.com/grouped-data-table/index.html`. Replace the URL with your own
...
4. **Open the .trex in Tableau** — In Tableau Desktop open a workbook,
   ...
   edited `grouped-data-table.trex` file.
...
For questions or issues visit https://github.com
